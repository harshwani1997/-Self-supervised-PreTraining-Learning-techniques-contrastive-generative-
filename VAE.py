...
Original file is located at
    https://colab.research.google.com/drive/1rPSN2lOzxvutuyPTp_iqrLoG4JyrDHK4
"""
...
#    parser = ArgumentParser()
   # parser.add_argument("--dataset", default="stl10", type=str, choices=["cifar10", "stl10", "imagenet"])
 ...
 #   args = parser.parse_args(args)
    ...
    callbacks = [ModelCheckpoint(monitor="val_loss", save_top_k=10, period=10, verbose=True)]
    #trainer = pl.Trainer(callbacks=callbacks)

    trainer = pl.Trainer(gpus=1, auto_scale_batch_size=True, min_epochs=100, max_epochs=100, precision=16, callbacks=callbacks, default_root_dir="./beta_VAE")
